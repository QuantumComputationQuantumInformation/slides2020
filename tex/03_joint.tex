...
\begin{itemize}
\item $\text{Set of states} = \left\{\omega\in \emm{V} \mid \omega\in C_{\succeq 0}, \langle I,\omega\rangle = 1\right\}$.
\item $\text{Set of binary measurements} = \left\{e\in \emm{V} \mid e\in C_{\succeq 0}, I-e \in C_{\succeq 0} \right\}$.
\end{itemize}
