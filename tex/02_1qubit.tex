...
\begin{tikzpicture}
    ...
    \addplot3[surf, samples= \xsample, samples y=\ysample, domain= 0:sqrt(2), domain y= 0:2*pi, mesh/interior colormap = {blueblack}{color=(cyan!50) color=(cyan!50)}, colormap = {blueblack}{color=(blue!60) color=(blue!60)}]
